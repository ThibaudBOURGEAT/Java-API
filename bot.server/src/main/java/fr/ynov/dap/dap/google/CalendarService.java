...
public class CalendarService extends GoogleService { 
	 ...
	 * @throws GeneralSecurityException the general security exception
	 */
	public CalendarModel getNextEvent(String userId)  throws IOException, GeneralSecurityException {
        ...
        CalendarModel calendarRes = new CalendarModel(items.get(0).getStart().toString(),
